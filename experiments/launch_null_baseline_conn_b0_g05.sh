...
# beta = 0 (hardcoded in fgw.py), gamma = 0.5. One SLURM array task per
# quantile Q in {0.9, 0.99, 0.999}; each task builds its 32 triples (8 archs
# × [trained + 3 seeds]) once and runs all 1404 FGW calls for that Q in a
# fork-based worker pool. Matches the headline sweep at
#   alpha_beta_sweep_logact_logload_conn_g0.5/
#
...
#
# Output:
#   ${result_path}/circuits/null_baseline_conn_g0.5/null_S_Q{0.9,0.99,0.999}.csv
#
